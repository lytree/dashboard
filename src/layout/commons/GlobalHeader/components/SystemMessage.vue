    ...
    <el-popover trigger="click" :width="384" placement="bottom-end">
        ...
        <el-tabs v-model="currentTab" class="w-[360px] !p-0">
            <el-tab-pane v-for="(item, index) in tabData" :label="item.key" :name="index" :stretch="true">
                ...
                <loading-empty-wrapper class="h-360px" :loading="loading" :empty="item.list.length === 0"
...
import IconClarityNotificationLine from '~icons/clarity/notification-line'
import { HoverContainer, LoadingEmptyWrapper } from '@/components'
